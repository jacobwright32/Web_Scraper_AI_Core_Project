...
class WebScraper:
    ...
    def user_country_selector(self):
        ...
        while country_selector != 'done' or country_selector != 'all':
            
            if country_selector.lower() == 'all':
                url_of_selected_countries = url_of_all_countries
                break
            
            elif country_selector.lower() == 'done':
                break
            
            else:
                url_of_selected_countries.append(name_and_url_of_all_countries[country_selector])
    ...
    def city_scraper(self):
        ...
        for url in urls:
            ...
            date_of_finish = datetime.strptime('31-01-2020','%d-%m-%Y')
        ...
        list_of_file_names.append(self.file_name)
